...
def draw_sound_toggle_button(screen, sound_enabled):
    """Draw sound toggle button in bottom right"""
    width, height = screen.get_size()
    ...
    pygame.draw.rect(screen, WHITE, (button_x, button_y, button_width, button_height), 2)
    if sound_enabled:
        pygame.draw.rect(screen, GREEN, (button_x + 1, button_y + 1, button_width - 2, button_height - 2))
        button_text = FONT_SMALL.render("ON", True, DARK_BROWN)
    else:
        pygame.draw.rect(screen, RED, (button_x + 1, button_y + 1, button_width - 2, button_height - 2))
        button_text = FONT_SMALL.render("OFF", True, WHITE)
    
    screen.blit(button_text, (button_x + 18, button_y + 10))
